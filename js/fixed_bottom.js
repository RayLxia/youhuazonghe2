...
document.writeln(".fixed_bottom ul li {    display: block;    padding-left: 50px;    loat:left;    color: #fff;    padding-top: 18px;    padding-bottom: 17px;    margin-right:60px;}");
...
document.writeln(".back_to_top:after {    right: -10px;    border-color: transparenttransparent #a6202e #a6202e;}");
...
document.writeln(".back_to_top a:before,.back_to_top a:after {    content: '';    osition:absolute;}");
document.writeln(".back_to_top a:before {    border-style: solid;    border-width: 12px13px;    border-color: transparent transparent #fff transparent;    top: 0;    left:50%;   margin-left: -12px;}");
...
document.writeln("    <a href=\"javascript:closeDown();\">x</a>");
document.writeln("    </div>");
document.writeln("    </div>");
document.writeln("    </div>");
